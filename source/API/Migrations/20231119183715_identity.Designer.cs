...
namespace Saitynai2.Migrations
{
    ...
    [Migration("20231119183715_identity")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Saitynai2.Auth.Model.SiteRestUser", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("text");
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("Saitynai2.Auth.Model.SiteRestUser", null)
                        .WithMany()
            ...
            modelBuilder.Entity("Saitynai2.Data.Entities.Comment", b =>
                {
                    ...
                    b.HasOne("Saitynai2.Auth.Model.SiteRestUser", "User")
                        .WithMany()
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
